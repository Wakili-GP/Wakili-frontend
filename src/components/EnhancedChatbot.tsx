        ...
        <ScrollArea className="h-full p-4" ref={scrollAreaRef}>
          <div className="space-y-4">
            {messages.map((message) => (
              ...
              >
                <div
                  className={`flex items-start space-x-reverse space-x-2 max-w-[80%] ${
